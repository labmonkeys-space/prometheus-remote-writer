...
📖 **Documentation:** <https://opennms-forge.github.io/prometheus-remote-writer/>
...
curl -L -o /opt/opennms/deploy/prometheus-remote-writer.kar \
    https://github.com/opennms-forge/prometheus-remote-writer/releases/latest/download/prometheus-remote-writer-kar.kar
...
The published [docs site](https://opennms-forge.github.io/prometheus-remote-writer/)
...
- 📖 [Docs site](https://opennms-forge.github.io/prometheus-remote-writer/) — full operator reference
